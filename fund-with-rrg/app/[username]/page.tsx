  ...
  return (
    <>
      <div className="cover relative">
        <img className="w-full h-[350px]  object-cover object-bottom" src="/cover.jpg" alt="coverImage" />
        <img width={80} className='absolute -bottom-9 left-[calc(50%-40px)] object-cover object-center rounded-xl w-20 h-20 border-2 border-white' src="/profile.jpg" alt="profileImage" />
      </div>
          ...
          <div className="supporters bg-slate-900 p-10 rounded-lg flex-grow">
            ...
            <ul className='ml-3 mt-3 space-y-4'>
              <li className='flex gap-3 items-center'>
                <img className='rounded-full object-cover object-center' width={25} src="/avatar.jpeg" alt="" />
                <div>
